...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '727062234318368',
    clientSecret : 'f2146bf146b9b7b3b86f6f35f0cb7f3e',
    callbackURL : 'https://geonhuiweb.herokuapp.com/auth/facebook/callback',
  ...
  passport.use(new GoogleStrategy({
    ...
    clientID : '1037479689629-rpomv2ohcn0ne9i82o0v42v1dd7o3d9u.apps.googleusercontent.com',
    clientSecret : 'K854XLIQcZnA5WD43zEMOnC7',
    callbackURL : 'http://geonhuiweb.herokuapp.com/auth/google/callback',
    profileFields : ['email', 'name', 'picture']
  }, async (token, refreshToken, profile, done) => {
...
//     // 이 부분을 여러분 Naver App의 정보로 수정해야 합니다.
//     clientID : 'ymuvxpROTPzmwDToVlXL',
//     clientSecret : 'SLNXyfkQoH',
